...
/* 
    0001 white king can castle to king side
    0010 white king can castle to queen side
    0100 black king can castle king side
    1000 black king can castle queen side
*/
...
/*
    binary move representation                          Hexidecimal constants
...
void print_move(int move) {
    ...
    printf("%s%s%c\n", square_to_coord[source_square], square_to_coord[target_square], piece_to_promoted_char(promoted));
}
